...
describe('constructor', () => {
  it('should set default values', () => {
    ...
    expect(simulation.yearlyExpenses).toBe(10000);
  ...
  it('should set values from initialValues', () => {
    ...
    expect(simulation.yearlyExpenses).toBe(20000);
...
describe('setters', () => {
  ...
  it('should set yearlyExpenses', () => {
    simulation.yearlyExpenses = 20000;
    expect(simulation.yearlyExpenses).toBe(20000);
    simulation.yearlyExpenses = -20000;
    expect(simulation.yearlyExpenses).toBe(0);
  })
...
describe("with NaN inputs", () => {
  ...
  it('should set yearlyExpenses to 0', () => {
    expect(simulation.yearlyExpenses).toBe(0);
  })
...
describe('yearlySalaryCotisations', () => {
  const simulation = new Simulation({ dailyRate: 500, daysPerWeek: 5, weeksOn: 47, weeksOff: 15, yearlyExpenses: 10000, monthlyNetSalary: 1000 });
...
describe('dividend', () => {
  ...
  describe("with 50% dividend", () => {
    const simulation = new Simulation({ dailyRate: 500, daysPerWeek: 5, weeksOn: 47, weeksOff: 15, yearlyExpenses: 10000, percentDividend: 50 });
...
describe('dividendCotisations', () => {
  it('should return 0 if netEarnings is negative', () => {
    const simulation = new Simulation({ yearlyExpenses: 10000, weeksOn: 1, weeksOff: 51 });
    expect(simulation.netEarnings()).toBeLessThan(0);
